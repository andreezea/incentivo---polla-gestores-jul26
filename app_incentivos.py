...
# ── Logo corporativo (imagen real incrustada en base64) ──────────────────────
...
_logo_html = f'<img src="data:image/png;base64,{_LOGO_B64}" style="height:70px;object-fit:contain;" alt="Fanero SAC">'
